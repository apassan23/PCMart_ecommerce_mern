    ...
    items: [
      {
        ...
        desc: 'Experience today’s biggest blockbusters like never before with the visual fidelity of real-time ray tracing and the ultimate performance of AI-powered DLSS. RTX. It’s On.',
      ...
      },
      {
        ...
        desc: 'The ASUS Z490 series features innovative designs that unleash the power of the latest 10th Gen Intel® Core™ processors. With intelligent overclocking, revolutionary cooling, robust power solution, optimized memory and next-gen connectivity, these boards come equipped to help you get the most out of your next Intel Z490 build. Yet, each model has its own distinctive traits, designed with specific segments in mind.',
      ...
      },
      {
        ...
        desc: 'CORSAIR VENGEANCE RGB Series DDR4 overclocked memory lights up your PC with mesmerizing dynamic multi-zone RGB lighting, while delivering the best in DDR4 performance.',
